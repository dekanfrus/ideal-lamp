...
namespace ChatServer {
    ...
    public partial class ChatServerDataSet : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UserRow AddUserRow(string userFirstName, string userLastName, string userEmail, string userName, string userPassword) {
...
namespace ChatServer.ChatServerDataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[User] WHERE (([userID] = @Original_userID) AND ([userFirstName] = @Original_userFirstName) AND ([userLastName] = @Original_userLastName) AND ([userEmail] = @Original_userEmail) AND ([userName] = @Original_userName) AND ([userPassword] = @Original_userPassword))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[User] ([userFirstName], [userLastName], [userEmail], [userName], [userPassword]) VALUES (@userFirstName, @userLastName, @userEmail, @userName, @userPassword);
SELECT userID, userFirstName, userLastName, userEmail, userName, userPassword FROM [User] WHERE (userID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [userFirstName] = @userFirstName, [userLastName] = @userLastName, [userEmail] = @userEmail, [userName] = @userName, [userPassword] = @userPassword WHERE (([userID] = @Original_userID) AND ([userFirstName] = @Original_userFirstName) AND ([userLastName] = @Original_userLastName) AND ([userEmail] = @Original_userEmail) AND ([userName] = @Original_userName) AND ([userPassword] = @Original_userPassword));
SELECT userID, userFirstName, userLastName, userEmail, userName, userPassword FROM [User] WHERE (userID = @userID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ChatServer.Properties.Settings.Default.ChatServerConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT userID, userFirstName, userLastName, userEmail, userName, userPassword FRO" +
                "M dbo.[User]";
        ...
        public virtual int Fill(ChatServerDataSet.UserDataTable dataTable) {
        ...
        public virtual ChatServerDataSet.UserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ChatServerDataSet.UserDataTable dataTable = new ChatServerDataSet.UserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ChatServerDataSet.UserDataTable dataTable) {
        ...
        public virtual int Delete(int Original_userID, string Original_userFirstName, string Original_userLastName, string Original_userEmail, string Original_userName, string Original_userPassword) {
        ...
        public virtual int Insert(string userFirstName, string userLastName, string userEmail, string userName, string userPassword) {
        ...
        public virtual int Update(string userFirstName, string userLastName, string userEmail, string userName, string userPassword, int Original_userID, string Original_userFirstName, string Original_userLastName, string Original_userEmail, string Original_userName, string Original_userPassword, int userID) {
            if ((userFirstName == null)) {
                throw new global::System.ArgumentNullException("userFirstName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string userFirstName, string userLastName, string userEmail, string userName, string userPassword, int Original_userID, string Original_userFirstName, string Original_userLastName, string Original_userEmail, string Original_userName, string Original_userPassword) {
            return this.Update(userFirstName, userLastName, userEmail, userName, userPassword, Original_userID, Original_userFirstName, Original_userLastName, Original_userEmail, Original_userName, Original_userPassword, Original_userID);
        }
    }
